...
{
    public:
        PublishTransformBack(const std::string& name, const BT::NodeConfiguration& config )
    ...
    private:
        ...
        void publish_transfor() {
            ...
            RCLCPP_DEBUG(node_->get_logger(),"Se publico correctamente el frame [back_frame]  !!!");
        }
